  ...
  return (
    <div
      ...
      style={{
        ...
        width: width || 600, // Tamaño mucho mayor para verificar cambios
        height: isMinimized ? 48 : (height || 800), // Tamaño mucho mayor para verificar cambios
        outline: 'none',
        border: 'none',
      }}
      onMouseDown={(e) => {
      ...
      {!isMinimized && (
        <div
          ...
          style={{
            ...
            backgroundColor: '#FEF3C7', // Amarillo muy claro
            backgroundImage: 'linear-gradient(#D4AF37 1px, transparent 1px)', // Líneas horizontales doradas
            backgroundSize: '100% 20px', // Interlineado ajustado para el nuevo tamaño
            fontFamily: '"Space Grotesk", sans-serif', // Tipografía Space Grotesk para Mini
            fontSize: '12px', // Space Grotesk 12px
            lineHeight: '1.3',
            whiteSpace: 'pre-wrap',
            border: 'none',
            outline: 'none',

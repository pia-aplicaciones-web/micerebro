...
export default function TodoListElement(props: CommonElementProps) {
  ...
  // No se utiliza useDictationBinding, ya que cada input manejará su dictado con useDictationInput
      ...
      <CardFooter className="p-2 pt-1.5 border-t border-gray-200/50">
        <div className="flex items-center gap-1 w-full">
          <textarea
            ...
            className="flex-grow text-sm border-none shadow-none focus:outline-none focus:ring-0 p-1 bg-transparent resize-none leading-snug"
